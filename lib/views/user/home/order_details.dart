...
class _OrderDetailsState extends State<OrderDetails> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(widget.task.paymentType ?? "r", style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Padding(
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(widget.task.reName ?? "r", style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(widget.task.reNum ?? "r", style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(widget.task.size ?? "r", style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(widget.task.type ?? "r", style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                      ],
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(child: Divider(thickness: 2)),
                              Text(" \₦ " + commaFormat.format(tax), style: TextStyle(fontSize: 16))
                            ],
                          ),
                        ),
                        Padding(
                  ...
                  widget.task.status == "Mark Completed"
                      ? MY_TYPE == "Dispatcher"
                          ? SizedBox()
                          : CustomButton(
                      ...
                      : SizedBox(),
                  widget.task.status == "Mark Completed" || widget.task.status == "Cancelled"
                      ? SizedBox()
                      : GestureDetector(
                          onTap: () {
                            showDialog(
  ...
  void cancelOrder() {
    ...
    writeBatch.setData(
        _firestore
            .collection("Orders")
            .document("Cancelled") //cancelled for dispatcher
            .collection(widget.task.disUid)
            .document(widget.task.id),
        widget.dataMap);
    ...
    writeBatch.setData(
        _firestore
            .collection("Orders")
            .document("Cancelled") //cancelled the customer
            .collection(widget.task.userUid)
            .document(widget.task.id),
        widget.dataMap);
  ...
  void _sendCancelNotification() async {
    String message =
        "Customer cancelled  the task at ${widget.task.from} by ${widget.task.name ?? "no-name"}";
